...
$pregunta07 = array('preg' => "¿Qué tienen en común el Catolicismo y los mitos griegos?", 'resp' => 'Ambos tienen como misión hacer que olvidemos la auténtica Historia reciente (últimos 13.000 años), que es una lucha entre paios (raza "naranja", malos) y bere (blancos, altos). Los mitos griegos ponen a los bere como monstruos (Grayas, Gorgonas...), seres alejados de donde viven los humanos (al morir el bere Alejandro Magno, por culpà de TeoDos / teo II; entonces, lo bere "es viejo"). El Catolicismo fue un chantaje a los bere: si queréis que NO se maten más niños, nos inventamos a un salvador (sí, en el siglo IV o por ahí), basado en un bere, para borrar de una vez por todas la Historia Bere. El original es Iezus, nacido sin ombligo, y del que vienen los blancos de la Tierra. Los negros son los originales de la Tierra. Santiago (que quiso la paz paiobere) sí que existió. Alexandre Eleazar, nieto del Zar Nicolás II, nos habló de paios y bere, con bastante solidez. Magno entregó "la sabiduría" a los iudas (paios), pero algunos se convirtieron en magos negros. Eso sí, hay hebreos de verdad, cumplidores, siendo la religión judía más pura, más elevada que el Cristianismo...');
 $pregunta08 = array('preg' => "¿A qué hemos venido?", 'resp' => 'A hacer crecer el alma limpiando la psique (represiones... Cuanta más "basura" nos pasan los padres en forma de creencias que no aguantamos y reprimimos... más crecimiento posible. Así como cargando con muertos, para resolver lo que ellos NO pudieron). Se limpia con encontronazos sociales (una represión sobre gordos te hace reaccionar mal ante ellos, y aceptar que eres incompleto, es la clave)... Y así, además, tenemos más éxito (creencias negativas que alejan el dinero...). Para finalizar, somos más felices al seguir la misión espiritual: Zodiaco y carta astral, Nodo Norte, Diseño Humano, Tzolkin Maya, Nombrelogía, tipo de manos, cejas... Se me olvidaba, el destino puede cerrarte puertas si el deseo NO es del alma / el objetivo NO forma parte de tu misión espiritual. ¡Y también si el destino quiere que te perfecciones en el comportamiento, te puede aislar y cerrar puertas, o si quiere que hagas cosas que NO son normales! ¡Y además, la enfermedad es psíquica casi en el 100% de los casos, y sirve para que demuestres que eres persona (inteligente) y miras dentro de ti! Lo que NO es enfermedad, se llama desequilibrio. Pero ojo, ¡incluso alimentarse mal puede tener origen psíquico, como una mala defensa del territorio, y eso es psicológico!');
 $pregunta09 = array('preg' => "¿Cómo te ganas tu barba?", 'resp' => 'Gritando contra psicópatas (infantilmente egoístas, se victimizan), TPLs infantiles (la gran mayoría, y con gran probabilidad son los niños abusones), mentirosos compulsivos (posibles asesinos, como los TPLs) y demás "vendedores"... ¿Quiénes irán al Infierno? Los que NO cuentan lo que saben (recetas...), los discretos, los superficiales (imagen cuidada frente a elevadas túnicas rotas, como las de los Aurones), gente que necesita mucho para ser feliz (se olvidaron de ser niños en el buen sentido), gente que viste sólo de negro (color que atrae malas vibraciones) o con el pelo muy corto (son obedientes), empollones y gente que duerme poco para hacer mucho (NO elevan el nivel, sino la esclavitud). La memoria NO selectiva es un poco de tontos (que son peligrosos): hay que crear, NO copiar. En el otro lado están los PAS (la estimulación externa los mata), y los que miran para dentro y los que tienen momentos de poca fescura mental (mediums e intuitivos...). Los hombres sigma son ejemplares, por otra parte. Hablemos de los psicópatas: son seres sociales, quieren atención (o "mueren"), y torturan en secreto, para autoreafirmarse. En público suelen ser encantadores y muy queridos (la gente suele ser inconsciente). Son manipuladores, y simulan ser NO psicópatas. ¿Son el 4% de la población? Los andropáusicos psicológicos, competitivos machos alfa (basura, como los beta, que quieren ser alfa)... los malforman un poco (como a los jóvenes), haciéndolos infelices.');

 $pregunta10 = array('preg' => "¿Qué contestas si la profe te dice que NO te fijas?", 'resp' => "Que somos diferentes, y que miras para dentro porque NO eres de sentidos, tu misión espiritual es de las más importantes.");
 $pregunta11 = array('preg' => "Precios bajos en transporte público, facilidades de pago... ¿Para qué?", 'resp' => "Quitar los coches, acabar con nuestra autonomía, dar tus datos... Si algo es gratis, el producto eres tú.");
 $pregunta12 = array('preg' => "Alejandro Magno era sueco / griego.", 'resp' => "Sueco (sólida teoría paiobere).");
 $pregunta13 = array('preg' => "Hay que distinguir entre psique, cuerpo y ().", 'resp' => "Cerebro (la psique, que es inmaterial, lo gobierna. Todavía hay gente en estado pez, que piensa que lo material viene de lo material. Por supuesto, el cerebro gobierna el órgano).");

 $preguntas = array($pregunta01, $pregunta02, $pregunta03, $pregunta04, $pregunta05, $pregunta06, $pregunta07, $pregunta08, $pregunta09, $pregunta10, $pregunta11, $pregunta12, $pregunta13); 
