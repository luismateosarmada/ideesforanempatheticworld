...
<BR>- U: muy racional; alegre y optimista, con gran don de la palabra. Inmovilidad. 2 o más: tenderás a acumular cosas sin valor.');
  ...
  {
   echo("<BR>Culín- Máscara bruta: ".$mascarabruta2.". ");
   bruto($mascarabruta2);
  }
  // if mascara == 1...
...
<BR>- 1 LA INSPIRACION (es el más creativo de todos los canales): inspira a los demás. Nos habla de que las peculiaridades sean reconocidas por el otro como una contribución.');
 ...
 function manos()
 {
  ...
  echo('<BR><BR>####Manos (cuadrada: pequeña; espátula: final dedos; gigante: primaria; cónica: dedos; nudosa: hueso dedos se ensancha; espiritual: fina y larga; las mixtas son de personas inteligentes, pero erráticas aplicando talentos. Ideas, diplomacia y tacto. ¿Lógicos y creativos, adaptables?):');

  if ($manocuadrada > 0) echo('<BR>- '.$manocuadrada.' Cuadrada: pequeña.
* Pequeñita. ¿Piel gruesa y roja? Metódicos, aman la seguridad. Son de lógica y paz, no de instinto. Fuertes y con apego a lo material. Suelen destacar en ocupaciones que requieren precisión, esfuerzo físico y una mentalidad lógica. ¿Artesanos?');
  if ($manoespatula > 0) echo('<BR>- '.$manoespatula.' Espátula: final dedos.
* Dedos + cortos que palma (palma relativamente grande). Piel rosada. Entusiastas, detallistas, optimistas. Percepción original. Vanidosos a veces. Fuerza física y resistencia. ¿Mineros y butaneros?');
  if ($manogigante > 0) echo('<BR>- '.$manogigante.' Gigante: primaria.
* Conformistas, trabajos físicos o pesados, apasionados, materialistas, poco arriesgados.');
  if ($manoconica > 0) echo('<BR>- '.$manoconica.' Cónica: dedos.
* Sensibles, ¿aman la tecnología? Se aburren fácilmente. Hábiles investigadores, activos y creativos. Lujo e indolencia. No razonan, juzgan por instinto e impulso. Conversadores generosos, simpáticos... Trabajo: imaginación, expresión y cierta sensibilidad hacia las emociones ajenas.');
  if ($manonudosa > 0) echo('<BR>- '.$manonudosa.' Nudosa (el filósofo): hueso dedos se ensancha durante "un centímetro".
* Suele ser organizado y paciente. Fuertes valores morales. Material o psíquico (según los nudos). Sinceridad, profundos, líderes naturales. Rara vez se olvidan de sus fallos. Uñas con terminación ancha (suave o recta / cuadrada). ¿Buenos para atención al detalle y esfuerzo constante? ¿Hacer bases de datos y "enciclopedias"? ¿Puede ser buen psicólogo?');
  if ($manoespiritual > 0) echo('<BR>- '.$manoespiritual.' Espiritual: fina y larga (agua vs cuadrada / tierra).
* Dedos cónicos. Débiles físicamente e inestables emocionalmente. Uñas almendradas (abajo un poco recto, y terminan suave, al revés que la avellanada). Fácilmente influenciables (por gurús...) y poco lógicos. Piel suave, flexible, blanda y rosada (¿y atractiva?). ¿Mediums?');
 }
